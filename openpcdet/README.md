...
[2020-11-10] The [Waymo Open Dataset](#waymo-open-dataset-baselines) has been supported with
...
Selected supported methods are shown in the below table. The results are the 3D detection
